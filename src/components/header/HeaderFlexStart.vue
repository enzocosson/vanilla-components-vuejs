...
<template>
  <div class="header__container">
    ...
    <div class="desktop">
      <h2>Desktop</h2>
      <img class="header_img" src="../../assets/img/header_flexstart/desktop.png" alt="" />
    </div>
    <div class="tablet">
      <h2>Tablet</h2>
      <img class="header_img" src="../../assets/img/header_flexstart/tablet.png" alt="" />
    </div>
    <div class="mobile">
      <h2>Mobile</h2>
      <img class="header_img" src="../../assets/img/header_flexstart/mobile.png" alt="" />
    </div>
  ...
  body {
    header {
      ...
      .burger {
        ...
        .line1_active {
          transform: rotate(45deg) translate(0.5vw, 2.9vw);
        }
        .line2_active {
          opacity: 0;
        }
...
.header__container {
  ...
  .header_img {
    height: 7vh;
    box-shadow: rgba(0, 0, 0, 0.054) 0px 1px 16px;
    transition: 0.3s ease-in-out;

    &:hover {
      box-shadow: rgba(222, 92, 53, 0.108) 0px 1px 16px;
    }
  }
  .btn {
    height: 4vh;
