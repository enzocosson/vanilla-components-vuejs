      ...
      <div class="html-scss">
        <div class="html">
          <pre>
            <div class="title">
               <span>HTML</span>
               <v-btn class="copy_html"  type="button">copy</v-btn>
             </div>
    ...
    &lt;/html&gt;
        ...
        <div class="scss">
          <pre>
            <div class="title">
               <span>SCSS</span>
               <v-btn class="copy_scss" @click="copyCode" type="button">copy</v-btn>
             </div>
             <div class="container__code">
                  <code class="code_scss">
    ...
    header {
      ...
      <div class="js">
        <pre>
            <div class="title">
               <span>JS</span>
               <v-btn class="copy_js" @click="copyCode" type="button">copy</v-btn>
             </div>
             <div class="container__code">
                  <code class="code_js">
function toggleMenu() {
